						...
						<div class="modal-dialog ', i = c["if"].call(b, (h = b && b.options, null == h || h === !1 ? h : h.smallmodals), {hash: {}, inverse: m.noop, fn: m.program(1, f, e), data: e}), (i || 0 === i) && (j += i), j += '">\n\
							...
							<div class="modal-content">\n\
								<div class="modal-header modal-header-primary">\n\
									...
									<h4 class="modal-title" id="heading">' + l((h = b && b.locale, h = null == h || h === !1 ? h : h.image, h = null == h || h === !1 ? h : h.insert, typeof h === k ? h.apply(b) : h)) + '</h4>\n\
								</div>\n\
								<div class="modal-body">\n\
									<div class="row"><div class="col-md-6" style="margin-bottom:15px">\
									<input type="hidden" id="wysihtml5-image-file-path" value="http://" class="bootstrap-wysihtml5-insert-image-url form-control">\
									<input type="file" required="true" name="wysihtml5_image" id="wysihtml5-image-upload" class="form-controls">\n\
									</div></div>\
									<div class="row form-group">\
										<div class="col-md-3">\
										<input type="radio" class="image_resize" name="image_resize" value="0X0" checked /> No Resize\
										</div>\
										<div class="col-md-3">\
										<input type="radio" class="image_resize" name="image_resize" value="150X0" /> 150-PX\
										</div>\
										<div class="col-md-3">\
										<input type="radio" class="image_resize" name="image_resize" value="200X0" /> 200-PX\
										</div>\
										<div class="col-md-3">\
										<input type="radio" class="image_resize" name="image_resize" value="250X0" /> 250-PX\
										</div>\
										<div class="spacer5px"></div>\
										<div class="col-md-12" style="padding-left:0">\
											<div class="col-md-5">\
											<input type="radio" class="image_resize" id="custom_resize" name="image_resize" value="-1" /> Custom Size (width X height)\
											</div>\
											<div class="image_dimentions hide col-md-7" id="custom_image_dimentions_div">\
												<div class="col-md-6">\
													<input type="text" class="form-control custom_diamention" placeholder = "600px" id="custom_width" value="0" />\
												</div>\
                                                <div class="col-md-6">\
                                                    <input type="text" class="form-control custom_diamention" placeholder = "400px" id="custom_hight" value="0" />\
                                                </div>\
											</div>\
										</div>\
									</div>\
								...
								<div class="modal-footer">\n\
									...
									<a class="btn btn-primary insert_image_button" id="insert_image_button" data-dismiss="modal">' + l((h = b && b.locale, h = null == h || h === !1 ? h : h.image, h = null == h || h === !1 ? h : h.insert, typeof h === k ? h.apply(b) : h)) + '</a>\n\
								</div>\n\
							</div>\n\
							</form>\
						</div>\n\
					</div>\n\
					<a id="wysihtml5_image_upload_icon" class="btn ', i = c["if"].call(b, (h = b && b.options, null == h || h === !1 ? h : h.size), {hash: {}, inverse: m.noop, fn: m.program(3, g, e), data: e}), (i || 0 === i) && (j += i), j += ' btn-default" data-wysihtml5-command="insertImage" title="' + l((h = b && b.locale, h = null == h || h === !1 ? h : h.image, h = null == h || h === !1 ? h : h.insert, typeof h === k ? h.apply(b) : h)) + '" tabindex="-1">\n\
