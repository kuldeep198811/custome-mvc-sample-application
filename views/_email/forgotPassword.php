...
<html lang="en">
  <head>
	...
	<link href="<?php echo $this->_assetRoot; ?>css/css/style.css" rel="stylesheet">
	...
	<table width="80%" style="margin:0 auto; font-family:Arial;">
		...
		<tr>
			...
			<td style="background:#fff; padding:50px; text-align:center;">
				<h1 style="font-size: 30px;">Password Reset</h1>
				<p style="margin-top: 32px; margin-bottom: 0; font-size: 18px;">Hey <name>,</p>
				<p style=" margin-bottom: 30px;">Seems like you forgot your password. If this is true, click below to reset your password.</p>
				<a href="<resetLink>" style="background: #d89300;color: #fff;font-size: 15px;padding: 10px 20px !important;text-transform: uppercase;border-radius: 0;border: 1px solid transparent;width: 20%;font-weight: 600;">Reset Password</a>
                <p style=" margin-bottom: 30px; margin-top: 30px;">If you did not forgot your password you can safely ignore this email</p>
			</td>
			<td></td>
		</tr>
		<tr>
